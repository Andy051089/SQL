...
FROM(
	SELECT 
		A.CHR_NO, A.ID_NO, B.FEE_NO, B.DEAD_DATE, 'W' AS HOS_GROUP
	FROM DBO.v_chr_basic_w A
	INNER JOIN DBO.v_chr_icd_w B
	ON A.CHR_NO = B.CHR_NO
UNION ALL
	SELECT 
		A.CHR_NO, A.ID_NO, B.FEE_NO, B.DEAD_DATE, 'T' AS HOS_GROUP
	FROM DBO.v_chr_basic_t A
	INNER JOIN DBO.v_chr_icd_t B
	ON A.CHR_NO = B.CHR_NO
UNION ALL
	SELECT 
		A.CHR_NO, A.ID_NO, B.FEE_NO, B.DEAD_DATE, 'S' AS HOS_GROUP
