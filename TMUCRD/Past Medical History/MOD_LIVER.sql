...
WHERE EXISTS (
    ...
    WHERE 
        code like '456.[0-2]' 
        or code like '572.[2-8]'
		or code like 'I85.[09]'
		or code like 'I86.4'
		or code like 'I98.2'
		or code like 'K70.4'
		or code like 'K7[12].1'
		or code like 'K72.9'
		or code like 'K76.[5-7]')
...
DROP TABLE LUNGCA_FINAL_MOD_LIVER
...
FROM (
    ...
    FROM(
        ...
        FROM IPD_MOD_LIVER T
    UNION ALL
        SELECT t1.ID_NO, t1.FEE_NO
        FROM OPD_MOD_LIVER T1
    ) AS TEMP
    GROUP BY ID_NO
    HAVING COUNT(FEE_NO) > 1
) T1
