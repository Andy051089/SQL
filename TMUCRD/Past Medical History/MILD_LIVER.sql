...
WHERE EXISTS (
    ...
    WHERE 
        code like '070.[23][23]' 
        or code like '070.[45]4'
		or code like '070.[69]'
		or code like '57[01]%'
		or code like '573.[3489]'
		or code like 'V42.7'
		or code like 'B18%'
		or code like 'K70.9'
		or code like 'K71.[3-5]'
		or code like 'K70.[0-3]'
		or code like 'K71.7'
		or code like 'K7[34]%'
		or code like 'K76.[2-4]'
		or code like 'K76.[089]'
		or code like 'Z94.4')
...
INTO LUNGCA_FINAL_MILD_LIVER
FROM(
	SELECT t.ID_NO, t.FEE_NO
	FROM IPD_MILD_LIVER T
UNION ALL
	SELECT t1.ID_NO, t1.FEE_NO
	FROM OPD_MILD_LIVER T1
) AS TEMP
GROUP BY ID_NO
HAVING COUNT(FEE_NO) > 1

DROP TABLE LUNGCA_FINAL_MILD_LIVER
